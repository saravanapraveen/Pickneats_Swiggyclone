                        ...
                        <nav class="breadcrumb-two mt-4 mb-4" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                ?>
                                        ...
                                        ?>
                                        <li class="breadcrumb-item" aria-current="page"><a href="javascript:void(0);">Shop Details</a></li>
                                <?php
                                    } else{
                                        if($ser_id != ''){
                                ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-2 col-md-2 col-sm-2 col-2">
                                        <?php
                                            if($ser_id == "" && $c_id == ""){
                                        ?>
                                                <a class="btn btn-primary float-right mt-2" href="add-shop.php">Add New</a>
                                        <?php
                                            }else{
                                                if($serv_id !="" && $c_id !=""){
                                        ?>
                                                    <a class="btn btn-primary float-right mt-2" href="add-shop.php?city_id=<?php echo $c_id;?>&service_id=<?php echo $ser_id;?>">Add New</a>
                                        <?php
                                                }else{
                                                    if($ser_id !=""){
                                        ?>
                                                        <a class="btn btn-primary float-right mt-2" href="add-shop.php?service_id=<?php echo $ser_id;?>">Add New</a>
                                        <?php
                                                    }else{
                                        ?>
                                                        <a class="btn btn-primary float-right mt-2" href="add-shop.php?city_id=<?php echo $c_id;?>">Add New</a>
                                        <?php
                                                    }
                                                }
                                            }
