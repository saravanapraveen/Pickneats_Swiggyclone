...
<head>
    ...
    <title>[Template - Title] | Pickneats</title>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <input type="text" name="name" id="name" class="form-control" placeholder="[Template] Name" autocomplete="off">
                                                                </div>
                                                            </div>
                                                        </div>
