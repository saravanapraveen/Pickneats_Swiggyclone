(function(a, b) {
    ...
    (function(g) {
        ...
        k.DEFAULTS = {
            ...
            countSelectedText: function(o, n, displayName) {
                return (o == 1) ? "{0} item selected" : "{0} " + displayName + " selected"
            },
            ...
            iconBase: "",
            tickIcon: "",
            tickValue: "<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-check'><polyline points='20 6 9 17 4 12'></polyline></svg>",
            showTick: false,
            template: {
        ...
        k.prototype = {
            ...
            createDropdown: function() {
                ...
                var uniqueId = this.$element.attr("uniqueId")
            ...
            createLi: function() {
                ...
                var v = function(B, y, A, z) {
                    ...
                    return "<span" + (typeof y !== "undefined" ? ' class="' + y + '"' : "") + (A ? ' style="' + A + '"' : "") + (u.options.liveSearchNormalize ? ' data-normalized-text="' + c(l(g(B).html())) + '"' : "") + (typeof z !== "undefined" || z !== null ? ' data-tokens="' + z + '"' : "") + ' role="option">' + B + '<span class="' + u.options.iconBase + " " + u.options.tickIcon + ' check-mark">' + u.options.tickValue + '</span></span>'
                };
            ...
            render: function(r) {
                ...
                if (this.multiple && this.options.selectedTextFormat.indexOf("count") > -1) {
                    let displayName = this.$element.attr("displayName")
                    let uniqueId = this.$element.attr("uniqueId")
                    ...
                    if ((s.length > 1 && p.length > s[1]) || (s.length == 1 && p.length >= 2)) {
                        ...
                        var u = o.not('[data-divider="true"], [data-hidden="true"]' + n).length,
                            v = (typeof this.options.countSelectedText === "function") ? this.options.countSelectedText(p.length, u, displayName) : this.options.countSelectedText;
            ...
            var o = this.each(function() {
                ...
                if (w.is("select")) {
                    ...
                    if (!v) {
                        ...
                        //     s.noneSelectedText = 'Select Users'
                        // }
